...
import type { NodeExecutionCapability, NodeTypeMetadata } from '@/components/workflow/types'
 ...
 */
export function getNodeExecutionCapability(nodeType: string): NodeExecutionCapability | null {
  const metadata = getNodeTypeMetadata(nodeType)
 ...
 */
export function registerNodeType(nodeType: string, metadata: NodeTypeMetadata): void {
