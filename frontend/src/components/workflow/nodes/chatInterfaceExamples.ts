  ...
  nodes: [
    // Friendly Assistant
    {
      ...
      data: {
        ...
        model: "GPT-3.5",
        systemPrompt:
          "You are a friendly and encouraging assistant who loves to help people.",
    ...
    // Technical Expert
    {
      ...
      data: {
        ...
        model: "GPT-4",
        systemPrompt:
          "You are a senior software engineer who provides detailed technical explanations.",
    ...
    // Creative Writer
    {
      ...
      data: {
        ...
        model: "GPT-4",
        systemPrompt:
          "You are a creative writer who helps with storytelling and content creation.",
    ...
    messages: [
      {
        ...
        role: "assistant",
        content:
          "Hello! I can help you with current information and real-time data. What would you like to know?",
        timestamp: new Date(),
      },
    ],
    disabled: false,
