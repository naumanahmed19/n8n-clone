...
export class ExecutionService {
  ...
  async getExecutionProgress(executionId: string): Promise<ExecutionProgress> {
    const response = await apiClient.get<ExecutionProgress>(`/executions/${executionId}/progress`)
  ...
  async getExecutionDetails(executionId: string): Promise<ExecutionDetails> {
    const response = await apiClient.get<ExecutionDetails>(`/executions/${executionId}`)
  ...
  async executeSingleNode(request: SingleNodeExecutionRequest): Promise<SingleNodeExecutionResult> {
    const response = await apiClient.post<SingleNodeExecutionResult>(`/executions/nodes/${request.nodeId}`, {
