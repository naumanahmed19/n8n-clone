...
export const ScheduleTriggerNode: NodeDefinition = {
  ...
  group: ['trigger'],
  version: 1,
  description: 'Triggers workflow execution on a schedule using cron expressions',
  icon: 'fa:clock',
  color: '#9C27B0',
  defaults: {
    cronExpression: '0 0 * * *',
  ...
  properties: [
    {
      ...
      required: true,
      default: '0 0 * * *',
      description: 'Cron expression defining when to trigger (e.g., "0 0 * * *" for daily at midnight)'
    },
    {
