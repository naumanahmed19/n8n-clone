...
export const AnthropicNode: NodeDefinition = {
  ...
  properties: [
    ...
    },
    {
      ...
      required: true,
      default: '',
      description: 'The message to send to Claude. You can use {{json.fieldName}} to reference input data.',
    ...
    },
    {
      ...
      required: false,
      default: 0.7,
      description: 'Controls randomness. Range: 0.0 to 1.0. Higher values make output more random.',
      placeholder: '0.7',
    },
    {
