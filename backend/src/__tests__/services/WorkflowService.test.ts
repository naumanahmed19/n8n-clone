...
describe('WorkflowService', () => {
    ...
    describe('createWorkflow', () => {
        it('should create a workflow successfully', async () => {
            ...
            const workflow = await workflowService.createWorkflow(testUserId, workflowData);
    ...
    describe('getWorkflow', () => {
        it('should get workflow by ID', async () => {
            const workflow = await workflowService.getWorkflow(testWorkflowId, testUserId);
    ...
    describe('updateWorkflow', () => {
        ...
        it('should throw error for invalid workflow update', async () => {
            ...
            await expect(
                workflowService.updateWorkflow(testWorkflowId, testUserId, invalidUpdateData)
            ).rejects.toThrow(AppError);
        });
    });
    ...
    describe('listWorkflows', () => {
        ...
        it('should filter workflows by search term', async () => {
            ...
            expect(result.workflows).toBeDefined();
            expect(result.workflows.every(w =>
        ...
        it('should filter workflows by active status', async () => {
            ...
            expect(result.workflows).toBeDefined();
            expect(result.workflows.every(w => w.active === true)).toBe(true);
        });
        ...
        it('should sort workflows correctly', async () => {
            ...
            if (result.workflows.length > 1) {
                for (let i = 1; i < result.workflows.length; i++) {
                    expect(result.workflows[i].name >= result.workflows[i - 1].name).toBe(true);
                }
            }
        });
    });
    ...
    describe('duplicateWorkflow', () => {
        ...
        it('should duplicate workflow with default name', async () => {
            const originalWorkflow = await workflowService.getWorkflow(testWorkflowId, testUserId);
            const duplicatedWorkflow = await workflowService.duplicateWorkflow(
                testWorkflowId,
                testUserId
            );
    ...
    describe('getWorkflowStats', () => {
        it('should return workflow statistics', async () => {
            ...
            expect(stats.totalWorkflows).toBe(stats.activeWorkflows + stats.inactiveWorkflows);
        });
    });
    ...
    describe('bulkUpdateWorkflows', () => {
        ...
        it('should bulk update workflows successfully', async () => {
            ...
            for (const workflowId of bulkTestWorkflowIds) {
                const workflow = await workflowService.getWorkflow(workflowId, testUserId);
    ...
    describe('deleteWorkflow', () => {
        it('should delete workflow successfully', async () => {
            const result = await workflowService.deleteWorkflow(testWorkflowId, testUserId);
